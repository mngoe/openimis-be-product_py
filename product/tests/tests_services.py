...
class HelpersTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.product = create_test_product(
            "ELI1",
            custom_props={"uuid": "eaa082a0-d71e-4526-a918-3239b098afa7"}
        )
        service = create_test_service(
            "V",
            custom_props={"code": "VVVV", 'uuid': "488d8bcb-5b88-438c-9077-f177f6f32625"}
        )
        create_test_product_service(self.product, service, custom_props={"limit_no_adult": 20})
        item = create_test_item(
            "A",
            custom_props={"name": "test_simple_batch", 'uuid': "71efb78b-64ee-4a68-be29-87daf566eb25"}
        )
    ...
    def test_save_history(self):
        ...
        data = {
            pattern.sub('_', key).lower():
                DATA_MUTATION['variables']['input'][key] for key in DATA_MUTATION['variables']['input']
        }
